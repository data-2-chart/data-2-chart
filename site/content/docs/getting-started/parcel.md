...
<img class="mb-4 img-fluid rounded-3" srcset="/docs/assets/img/guides/bootstrap-parcel.png, /docs/assets/img/guides/bootstrap-parcel@2x.png 2x" src="/docs/assets/img/guides/bootstrap-parcel.png" width="2000" height="1000" alt="">
...
3. **And finally, we can start Parcel.** From the `my-project` folder in your terminal, run that newly added npm script:
   ...
   <img class="img-fluid" src="/docs/assets/img/guides/parcel-dev-server.png" alt="Parcel dev server running">
...
3. **And you're done! 🎉** With Bootstrap's source Sass and JS fully loaded, your local development server should now look like this.
   ...
   <img class="img-fluid" src="/docs/assets/img/guides/parcel-dev-server-bootstrap.png" alt="Parcel dev server running with Bootstrap">
