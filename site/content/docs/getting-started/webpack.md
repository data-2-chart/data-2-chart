...
<img class="mb-4 img-fluid rounded-3" srcset="/docs/assets/img/guides/bootstrap-webpack.png, /docs/assets/img/guides/bootstrap-webpack@2x.png 2x" src="/docs/assets/img/guides/bootstrap-webpack.png" width="2000" height="1000" alt="">
...
4. **And finally, we can start Webpack.** From the `my-project` folder in your terminal, run that newly added npm script:
   ...
   <img class="img-fluid" src="/docs/assets/img/guides/webpack-dev-server.png" alt="Webpack dev server running">
...
4. **And you're done! 🎉** With Bootstrap's source Sass and JS fully loaded, your local development server should now look like this.
   ...
   <img class="img-fluid" src="/docs/assets/img/guides/webpack-dev-server-bootstrap.png" alt="Webpack dev server running with Bootstrap">
